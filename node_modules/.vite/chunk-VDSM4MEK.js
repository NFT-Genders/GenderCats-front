...
init_define_process_env();
var version3 = "abstract-provider/5.4.1";
...
init_define_process_env();
var version7 = "signing-key/5.4.0";
...
init_define_process_env();
var version8 = "transactions/5.4.0";
...
var Formatter = class {
  constructor() {
    logger10.checkNew(new.target, Formatter);
  ...
  hex(value, strict) {
    ...
    return logger10.throwArgumentError("invalid hash", "value", value);
  }
  data(value, strict) {
      ...
      if (result.root.length <= 4) {
        ...
        if (value2 === 0 || value2 === 1) {
          if (result.status != null && result.status !== value2) {
            logger10.throwArgumentError("alt-root-status/status mismatch", "value", { root: result.root, status: result.status });
          }
          result.status = value2;
          delete result.root;
        } else {
          logger10.throwArgumentError("invalid alt-root-status", "value.root", result.root);
        }
      } else if (result.root.length !== 66) {
        logger10.throwArgumentError("invalid root hash", "value.root", result.root);
      }
    }
...
var logger16 = new Logger(version9);
...
var BaseProvider = class extends Provider {
  constructor(network) {
    logger16.checkNew(new.target, Provider);
    super();
    this._events = [];
  ...
  _getResolver(name2) {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (!network.ensAddress) {
        logger16.throwError("network does not support ENS", Logger.errors.UNSUPPORTED_OPERATION, { operation: "ENS", network: network.name });
      }
      const transaction = {
  ...
  resolveName(name2) {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (typeof name2 !== "string") {
        logger16.throwArgumentError("invalid ENS name", "name", name2);
      }
...
init_define_process_env();
var version14 = "abstract-signer/5.4.1";
...
var VoidSigner = class extends Signer {
  ...
  _fail(message, operation) {
    return Promise.resolve().then(() => {
      logger17.throwError(message, Logger.errors.UNSUPPORTED_OPERATION, { operation });
    });
  }
  signMessage(message) {
...
var logger18 = new Logger(version9);
...
try {
  ...
  const logger31 = new Logger(version9);
  WS = function() {
...
var logger19 = new Logger(version9);
var NextId = 1;
...
var logger20 = new Logger(version9);
...
init_define_process_env();
"use strict";
var logger21 = new Logger(version9);
...
var logger22 = new Logger(version9);
...
var logger23 = new Logger(version9);
...
var logger25 = new Logger(version9);
function now() {
  return new Date().getTime();
}
...
init_define_process_env();
"use strict";
var logger26 = new Logger(version9);
...
init_define_process_env();
"use strict";
var logger27 = new Logger(version9);
...
init_define_process_env();
"use strict";
var logger28 = new Logger(version9);
...
init_define_process_env();
"use strict";
var logger29 = new Logger(version9);
var _nextId = 1;
...
init_define_process_env();
"use strict";
var logger30 = new Logger(version9);
...
//# sourceMappingURL=chunk-VDSM4MEK.js.map
