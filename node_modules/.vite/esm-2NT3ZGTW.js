...
var require_cjs3 = __commonJS({
  "node_modules/@walletconnect/encoding/dist/cjs/index.js"(exports) {
    ...
    function bufferToHex2(buf, prefixed = false) {
      ...
      return prefixed ? addHexPrefix4(hex) : hex;
    }
    ...
    function addHexPrefix4(hex) {
      return hex.startsWith("0x") ? hex : `0x${hex}`;
    }
    exports.addHexPrefix = addHexPrefix4;
    function sanitizeHex4(hex) {
      hex = removeHexPrefix5(hex);
      hex = sanitizeBytes(hex, 2);
      if (hex) {
        hex = addHexPrefix4(hex);
      }
      return hex;
    }
...
var require_cjs5 = __commonJS({
  "node_modules/@walletconnect/qrcode-modal/dist/cjs/index.js"(exports, module) {
          ...
          var initLinks = function() {
            try {
              ...
              var _temp = _catch(function() {
                ...
                return Promise.resolve(fetch(url).then(function(x3) {
                  return x3.json();
    ...
    var de = {
      ...
      no_supported_wallets: "Es gibt noch keine unterst\xFCtzten Geldb\xF6rsen"
    };
    var en = {
    ...
    var es = {
      ...
      no_supported_wallets: "Todav\xEDa no hay monederos compatibles"
    };
    var fr = {
  ...
  "node_modules/hash-base/index.js"(exports, module) {
    ...
    HashBase.prototype.update = function(data, encoding5) {
      ...
      if (!Buffer2.isBuffer(data))
        data = Buffer2.from(data, encoding5);
    ...
    HashBase.prototype.digest = function(encoding5) {
      ...
      if (encoding5 !== void 0)
        digest = digest.toString(encoding5);
      this._block.fill(0);
      this._blockOffset = 0;
      for (var i3 = 0; i3 < 4; ++i3)
        this._length[i3] = 0;
...
var require_dist3 = __commonJS({
  "node_modules/ethereumjs-util/dist/index.js"(exports) {
    ...
    var assert2 = (init_assert(), assert_exports);
    ...
    module.exports = function(source, reviver) {
      ...
      return typeof reviver === "function" ? function walk(holder, key) {
        ...
        if (value2 && typeof value2 === "object") {
          for (k3 in value2) {
            if (Object.prototype.hasOwnProperty.call(value2, k3)) {
              v3 = walk(value2, k3);
              if (v3 !== void 0) {
                value2[k3] = v3;
              } else {
...
var require_stringify = __commonJS({
  "node_modules/jsonify/lib/stringify.js"(exports, module) {
    ...
    function str(key, holder) {
      var i3, k3, v3, length, mind = gap, partial, value = holder[key];
...
init_define_process_env();
var import_bn = __toModule(require_bn2());
...
function convertNumberToHex(num, noPrefix) {
  const hex = encoding.removeHexPrefix(encoding.sanitizeHex(new import_bn.default(num).toString(16)));
...
function toChecksumAddress(address) {
  ...
  const hash = (0, import_encoding.removeHexPrefix)((0, import_js_sha3.keccak_256)(convertUtf8ToBuffer(address)));
  let checksum = "";
...
async function verifyHmac(payload, key) {
  ...
  const hmac = encoding4.hexToArray(payload.hmac);
  const hmacHex = encoding4.arrayToHex(hmac, false);
...
async function encrypt(data, key, providedIv) {
  const _key = encoding4.bufferToArray(convertArrayBufferToBuffer(key));
...
async function decrypt(payload, key) {
  ...
  const utf8 = encoding4.arrayToUtf8(buffer);
  let data;
  try {
 ...
 * @license MIT
 */
//# sourceMappingURL=esm-2NT3ZGTW.js.map
