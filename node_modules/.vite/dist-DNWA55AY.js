...
} from "./chunk-PHHR2MCG.js";
import {
  buffer_exports,
  init_buffer
} from "./chunk-FNTQD2BJ.js";
import "./chunk-ZT2DFEDG.js";
import {
  __commonJS,
  __esm,
  __export,
...
var require_util = __commonJS({
  "node_modules/walletlink/dist/util.js"(exports2) {
    ...
    function ensureHexString(hex, includePrefix = false) {
      if (typeof hex === "string") {
        ...
        if (HEXADECIMAL_STRING_REGEX.test(s3)) {
          return types_1.HexString(includePrefix ? "0x" + s3 : s3);
        }
      }
    ...
    function ensureEvenLengthHexString(hex, includePrefix = false) {
      ...
      if (h3.length % 2 === 1) {
        h3 = types_1.HexString("0" + h3);
      }
      return includePrefix ? types_1.HexString("0x" + h3) : h3;
    }
    ...
    function ensureAddressString(str) {
      if (typeof str === "string") {
        ...
        if (isHexString(s3) && s3.length === 40) {
          return types_1.AddressString(prepend0x(s3));
        }
      }
    ...
    var FilterPolyfill = class {
      ...
      async getLogFilterChanges(id) {
        ...
        if (Array.isArray(response.result)) {
          const blocks2 = response.result.map((log) => util_1.intNumberFromHexString(log.blockNumber || "0x0"));
      ...
      async getBlockFilterChanges(id) {
        ...
        const blocks2 = (await Promise.all(util_1.range(cursorPosition, currentBlockHeight + 1).map((i3) => this.getBlockHashByNumber(types_1.IntNumber(i3))))).filter((hash) => !!hash);
        const newCursorPosition = types_1.IntNumber(cursorPosition + blocks2.length);
        console.log(`Moving cursor position for filter (${id}) from ${cursorPosition} to ${newCursorPosition}`);
        this.cursors.set(id, newCursorPosition);
...
var require_EthereumChain = __commonJS({
  "node_modules/walletlink/dist/EthereumChain.js"(exports2) {
    init_define_process_env();
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    ...
    })(EthereumChain = exports2.EthereumChain || (exports2.EthereumChain = {}));
    (function(EthereumChain2) {
    ...
    var WalletLinkProvider = class extends safe_event_emitter_1.default {
      ...
      _sendRequestAsync(request) {
        return new Promise((resolve, reject) => {
          ...
          this._handleAsynchronousMethods(request).then((res) => resolve(Object.assign(Object.assign({}, res), { id: request.id }))).catch((err) => reject(err));
        });
      }
...
var require_Spinner = __commonJS({
  "node_modules/walletlink/dist/components/Spinner.js"(exports2) {
    ...
    var Spinner = (props) => {
      ...
      return preact_1.h("div", { class: "-walletlink-spinner" }, preact_1.h("style", null, Spinner_css_1.default), preact_1.h("svg", { viewBox: "0 0 100 100", xmlns: "http://www.w3.org/2000/svg", style: { width: size, height: size } }, preact_1.h("circle", { style: { cx: 50, cy: 50, r: 45, stroke: color } })));
    };
...
var require_LinkDialog = __commonJS({
  "node_modules/walletlink/dist/components/LinkDialog.js"(exports2) {
    ...
    var LinkDialog = (props) => {
      ...
      return preact_1.h("div", { class: clsx_1.default("-walletlink-link-dialog-container", props.darkMode && "-walletlink-link-dialog-container-dark", isContainerHidden && "-walletlink-link-dialog-container-hidden") }, preact_1.h("style", null, LinkDialog_css_1.default), preact_1.h("div", { class: clsx_1.default("-walletlink-link-dialog-backdrop", isDialogHidden && "-walletlink-link-dialog-backdrop-hidden") }), preact_1.h("div", { class: "-walletlink-link-dialog" }, preact_1.h("div", { class: clsx_1.default("-walletlink-link-dialog-box", isDialogHidden && "-walletlink-link-dialog-box-hidden") }, preact_1.h(ScanQRCode, { darkMode: props.darkMode, version: props.version, sessionId: props.sessionId, sessionSecret: props.sessionSecret, walletLinkUrl: props.walletLinkUrl, isConnected: props.isConnected, isParentConnection: props.isParentConnection }), props.onCancel && preact_1.h(CancelButton, { onClick: props.onCancel }))));
    };
    ...
    var ScanQRCode = (props) => {
      ...
      return preact_1.h("div", { class: "-walletlink-link-dialog-box-content" }, preact_1.h("h3", null, "Scan to", preact_1.h("br", null), " Connect"), preact_1.h("div", { class: "-walletlink-link-dialog-box-content-qrcode" }, preact_1.h("div", { class: "-walletlink-link-dialog-box-content-qrcode-wrapper" }, preact_1.h(QRCode_1.QRCode, { content: qrUrl, width: 224, height: 224, fgColor: "#000", bgColor: "transparent" })), preact_1.h("input", { type: "hidden", value: qrUrl }), !props.isConnected && preact_1.h("div", { class: "-walletlink-link-dialog-box-content-qrcode-connecting" }, preact_1.h(Spinner_1.Spinner, { size: 128, color: props.darkMode ? "#fff" : "#000" }), preact_1.h("p", null, "Connecting...")), preact_1.h("p", { title: `WalletLink v${props.version}` }, "Powered by WalletLink")), preact_1.h("a", { href: `${props.walletLinkUrl}/#/wallets`, target: "_blank", rel: "noopener" }, "Don\u2019t have a wallet app?"));
    };
    var CancelButton = (props) => preact_1.h("button", { class: "-walletlink-link-dialog-box-cancel", onClick: props.onClick }, preact_1.h("div", { class: "-walletlink-link-dialog-box-cancel-x" }));
  }
});
...
var require_TryExtensionLinkDialog = __commonJS({
  "node_modules/walletlink/dist/components/TryExtensionLinkDialog.js"(exports2) {
    ...
    var TryExtensionLinkDialog = (props) => {
      ...
      return preact_1.h("div", { class: clsx_1.default("-walletlink-extension-dialog-container", isContainerHidden && "-walletlink-extension-dialog-container-hidden") }, preact_1.h("style", null, TryExtensionLinkDialog_css_1.default), preact_1.h("div", { class: clsx_1.default("-walletlink-extension-dialog-backdrop", isDialogHidden && "-walletlink-extension-dialog-backdrop-hidden") }), preact_1.h("div", { class: "-walletlink-extension-dialog" }, preact_1.h("div", { class: clsx_1.default("-walletlink-extension-dialog-box", isDialogHidden && "-walletlink-extension-dialog-box-hidden") }, preact_1.h(TryExtensionBox, { onInstallClick: () => {
        window.open("https://api.wallet.coinbase.com/rpc/v2/desktop/chrome", "_blank");
      } }), !props.connectDisabled ? preact_1.h(ScanQRBox, { darkMode: props.darkMode, version: props.version, sessionId: props.sessionId, sessionSecret: props.sessionSecret, walletLinkUrl: props.walletLinkUrl, isConnected: props.isConnected, isParentConnection: props.isParentConnection }) : null, props.onCancel && preact_1.h(CancelButton, { onClick: props.onCancel }))));
    };
    exports2.TryExtensionLinkDialog = TryExtensionLinkDialog;
    var TryExtensionBox = (props) => {
      return preact_1.h("div", { class: "-walletlink-extension-dialog-box-top" }, preact_1.h("div", { class: "-walletlink-extension-dialog-box-top-install-region" }, preact_1.h("h2", null, "Try Coinbase Wallet extension"), preact_1.h("button", { onClick: props.onInstallClick }, "Install")), preact_1.h("div", { class: "-walletlink-extension-dialog-box-top-info-region" }, preact_1.h(DescriptionItem, { icon: link_icon_svg_1.default, text: "Connect to crypto apps with one click" }), preact_1.h(DescriptionItem, { icon: lock_icon_svg_1.default, text: "Private keys remain secure on mobile app" }), preact_1.h(DescriptionItem, { icon: globe_icon_svg_1.default, text: "Compatible with all crypto apps" })));
    };
    var ScanQRBox = (props) => {
      const serverUrl = window.encodeURIComponent(props.walletLinkUrl);
      const sessionIdKey = props.isParentConnection ? "parent-id" : "id";
      const qrUrl = `${props.walletLinkUrl}/#/link?${sessionIdKey}=${props.sessionId}&secret=${props.sessionSecret}&server=${serverUrl}&v=1`;
      return preact_1.h("div", { class: "-walletlink-extension-dialog-box-bottom" }, preact_1.h("div", { class: "-walletlink-extension-dialog-box-bottom-description-region" }, preact_1.h("h2", null, "Or scan to connect"), preact_1.h("body", { class: "-walletlink-extension-dialog-box-bottom-description" }, "Open ", preact_1.h("a", { href: "https://wallet.coinbase.com/" }, "Coinbase Wallet"), " on your mobile phone and scan")), preact_1.h("div", { class: "-walletlink-extension-dialog-box-bottom-qr-region" }, preact_1.h("div", { class: "-walletlink-extension-dialog-box-bottom-qr-wrapper" }, preact_1.h(QRCode_1.QRCode, { content: qrUrl, width: 150, height: 150, fgColor: "#000", bgColor: "transparent", image: {
        svg: QRLogo_1.default,
        width: 34,
        height: 34
      } })), preact_1.h("input", { type: "hidden", value: qrUrl }), !props.isConnected && preact_1.h("div", { class: "-walletlink-extension-dialog-box-bottom-qr-connecting" }, preact_1.h(Spinner_1.Spinner, { size: 36, color: "#000" }), preact_1.h("p", null, "Connecting..."))));
    };
    var DescriptionItem = (props) => {
      return preact_1.h("div", { class: "-walletlink-extension-dialog-box-top-description" }, preact_1.h("div", { class: "-walletlink-extension-dialog-box-top-description-icon-wrapper" }, preact_1.h("img", { src: props.icon })), preact_1.h("body", { class: "-walletlink-extension-dialog-box-top-description-text" }, props.text));
    };
    var CancelButton = (props) => preact_1.h("button", { class: "-walletlink-extension-dialog-box-cancel", onClick: props.onClick }, preact_1.h("div", { class: "-walletlink-extension-dialog-box-cancel-x" }));
  }
});
  ...
  "node_modules/walletlink/dist/components/LinkFlow.js"(exports2) {
    ...
    var LinkFlow = class {
      ...
      render() {
        ...
        const subscription = this.extensionUI$.pipe(operators_1.first((enabled) => enabled.value !== void 0)).subscribe((enabled) => {
          if (!this.root) {
            return;
          }
  ...
  "node_modules/walletlink/dist/components/Snackbar.js"(exports2) {
    ...
    var Snackbar = class {
      ...
      render() {
        ...
        preact_1.render(preact_1.h("div", null, preact_1.h(SnackbarContainer, { darkMode: this.darkMode }, Array.from(this.items.entries()).map(([key, itemProps]) => preact_1.h(SnackbarInstance, Object.assign({}, itemProps, { key }))))), this.root);
      }
    };
    exports2.Snackbar = Snackbar;
    var SnackbarContainer = (props) => preact_1.h("div", { class: clsx_1.default("-walletlink-snackbar-container") }, preact_1.h("style", null, Snackbar_css_1.default), preact_1.h("div", { class: "-walletlink-snackbar" }, props.children));
    var SnackbarInstance = ({ message, menuItems }) => {
      ...
      return preact_1.h("div", { class: clsx_1.default("-walletlink-snackbar-instance", hidden && "-walletlink-snackbar-instance-hidden", expanded && "-walletlink-snackbar-instance-expanded") }, preact_1.h("div", { class: "-walletlink-snackbar-instance-header", onClick: toggleExpanded }, preact_1.h("img", { src: cblogo, class: "-walletlink-snackbar-instance-header-cblogo" }), preact_1.h("div", { class: "-walletlink-snackbar-instance-header-message" }, message), preact_1.h("div", { class: "-gear-container" }, !expanded && preact_1.h("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, preact_1.h("circle", { cx: "12", cy: "12", r: "12", fill: "#F5F7F8" })), preact_1.h("img", { src: gearIcon, class: "-gear-icon", title: "Expand" }))), menuItems && menuItems.length > 0 && preact_1.h("div", { class: "-walletlink-snackbar-instance-menu" }, menuItems.map((action, i3) => preact_1.h("div", { class: clsx_1.default("-walletlink-snackbar-instance-menu-item", action.isRed && "-walletlink-snackbar-instance-menu-item-is-red"), onClick: action.onClick, key: i3 }, preact_1.h("svg", { width: action.svgWidth, height: action.svgHeight, viewBox: "0 0 10 11", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, preact_1.h("path", { "fill-rule": action.defaultFillRule, "clip-rule": action.defaultClipRule, d: action.path, fill: "#AAAAAA" })), preact_1.h("span", { class: clsx_1.default("-walletlink-snackbar-instance-menu-item-info", action.isRed && "-walletlink-snackbar-instance-menu-item-info-is-red") }, action.info)))));
    };
  }
});
  ...
  "node_modules/walletlink/dist/connection/RxWebSocket.js"(exports2) {
    ...
    var RxWebSocket = class {
      ...
      get incomingJSONData$() {
        return this.incomingData$.pipe(operators_1.flatMap((m3) => {
          let j3;
          try {
            j3 = JSON.parse(m3);
          } catch (err) {
  ...
  "node_modules/walletlink/dist/connection/WalletLinkConnection.js"(exports2) {
    ...
    var WalletLinkConnection = class {
      constructor(sessionId, sessionKey, serverUrl, WebSocketClass = WebSocket) {
        ...
        this.ws = ws;
        this.subscriptions.add(ws.connectionState$.pipe(operators_1.skip(1), operators_1.filter((cs) => cs === RxWebSocket_1.ConnectionState.DISCONNECTED && !this.destroyed), operators_1.delay(5e3), operators_1.filter((_3) => !this.destroyed), operators_1.flatMap((_3) => ws.connect()), operators_1.retry()).subscribe());
        this.subscriptions.add(ws.connectionState$.pipe(operators_1.skip(2), operators_1.switchMap((cs) => rxjs_1.iif(() => cs === RxWebSocket_1.ConnectionState.CONNECTED, this.authenticate().pipe(operators_1.tap((_3) => this.sendIsLinked()), operators_1.tap((_3) => this.sendGetSessionConfig()), operators_1.map((_3) => true)), rxjs_1.of(false))), operators_1.distinctUntilChanged(), operators_1.catchError((_3) => rxjs_1.of(false))).subscribe((connected) => this.connectedSubject.next(connected)));
        this.subscriptions.add(ws.connectionState$.pipe(operators_1.skip(1), operators_1.switchMap((cs) => rxjs_1.iif(() => cs === RxWebSocket_1.ConnectionState.CONNECTED, rxjs_1.timer(0, HEARTBEAT_INTERVAL)))).subscribe((i3) => i3 === 0 ? this.updateLastHeartbeat() : this.heartbeat()));
        this.subscriptions.add(ws.incomingData$.pipe(operators_1.filter((m3) => m3 === "h")).subscribe((_3) => this.updateLastHeartbeat()));
        this.subscriptions.add(ws.incomingJSONData$.pipe(operators_1.filter((m3) => ["IsLinkedOK", "Linked"].includes(m3.type))).subscribe((m3) => {
          const msg = m3;
          this.linkedSubject.next(msg.linked || msg.onlineGuests > 0);
        }));
        this.subscriptions.add(ws.incomingJSONData$.pipe(operators_1.filter((m3) => ["GetSessionConfigOK", "SessionConfigUpdated"].includes(m3.type))).subscribe((m3) => {
          const msg = m3;
      ...
      get onceConnected$() {
        return this.connected$.pipe(operators_1.filter((v3) => v3), operators_1.take(1), operators_1.map(() => void 0));
      }
      get linked$() {
        return this.linkedSubject.asObservable();
      }
      get onceLinked$() {
        return this.linked$.pipe(operators_1.filter((v3) => v3), operators_1.take(1), operators_1.map(() => void 0));
      }
      get sessionConfig$() {
        return this.sessionConfigSubject.asObservable();
      }
      get incomingEvent$() {
        return this.ws.incomingJSONData$.pipe(operators_1.filter((m3) => {
          if (m3.type !== "Event") {
            return false;
          }
          const sme = m3;
          return typeof sme.sessionId === "string" && typeof sme.eventId === "string" && typeof sme.event === "string" && typeof sme.data === "string";
        }), operators_1.map((m3) => m3));
      }
      setSessionMetadata(key, value) {
        ...
        return this.onceConnected$.pipe(operators_1.flatMap((_3) => this.makeRequest(message)), operators_1.map((res) => {
      ...
      publishEvent(event, data, callWebhook = false) {
        ...
        return this.onceLinked$.pipe(operators_1.flatMap((_3) => this.makeRequest(message)), operators_1.map((res) => {
          if (ServerMessage_1.isServerMessageFail(res)) {
      ...
      makeRequest(message, timeout2 = REQUEST_TIMEOUT) {
        ...
        return this.ws.incomingJSONData$.pipe(operators_1.timeoutWith(timeout2, rxjs_1.throwError(new Error(`request ${reqId} timed out`))), operators_1.filter((m3) => m3.id === reqId), operators_1.take(1));
      }
      authenticate() {
...
var require_Web3Method = __commonJS({
  "node_modules/walletlink/dist/relay/Web3Method.js"(exports2) {
    ...
    (function(Web3Method2) {
      ...
      Web3Method2["arbitrary"] = "arbitrary";
...
var require_Web3Response = __commonJS({
  "node_modules/walletlink/dist/relay/Web3Response.js"(exports2) {
    ...
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.ChildRequestEthereumAccountsResponse = exports2.isRequestEthereumAccountsResponse = exports2.RequestEthereumAccountsResponse = exports2.SwitchEthereumChainResponse = exports2.ErrorResponse = void 0;
    var Web3Method_1 = require_Web3Method();
    function ErrorResponse(method2, errorMessage) {
      return { method: method2, errorMessage };
    }
    ...
    exports2.ChildRequestEthereumAccountsResponse = ChildRequestEthereumAccountsResponse;
  }
});
...
var require_WalletLinkRelayAbstract = __commonJS({
  "node_modules/walletlink/dist/relay/WalletLinkRelayAbstract.js"(exports2) {
    ...
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.WalletLinkRelayAbstract = exports2.WALLET_USER_NAME_KEY = void 0;
  ...
  "node_modules/walletlink/dist/relay/WalletLinkRelay.js"(exports2) {
    ...
    var WalletLinkRelay = class {
      constructor(options) {
        ...
        this.connection.incomingEvent$.pipe(operators_1.filter((m3) => m3.event === "Web3Response")).subscribe({ next: this.handleIncomingEvent });
        this.connection.sessionConfig$.pipe(operators_1.filter((c3) => !!c3.metadata && c3.metadata.__destroyed === "1")).subscribe({ next: this.resetAndReload });
        this.connection.sessionConfig$.pipe(operators_1.filter((c3) => c3.metadata && c3.metadata.WalletUsername !== void 0)).pipe(operators_1.mergeMap((c3) => aes256gcm.decrypt(c3.metadata.WalletUsername, this.session.secret))).subscribe({
          next: (walletUsername) => {
            this.storage.setItem(WalletLinkRelayAbstract_1.WALLET_USER_NAME_KEY, walletUsername);
          }
        });
        this.connection.sessionConfig$.pipe(operators_1.filter((c3) => c3.metadata && c3.metadata.ChainId !== void 0)).pipe(operators_1.mergeMap((c3) => aes256gcm.decrypt(c3.metadata.ChainId, this.session.secret))).pipe(operators_1.distinctUntilChanged()).subscribe({
          next: (chainId) => {
        ...
        this.connection.sessionConfig$.pipe(operators_1.filter((c3) => c3.metadata && c3.metadata.JsonRpcUrl !== void 0)).pipe(operators_1.mergeMap((c3) => aes256gcm.decrypt(c3.metadata.JsonRpcUrl, this.session.secret))).pipe(operators_1.distinctUntilChanged()).subscribe({
          next: (jsonRpcURl) => {
        ...
        this.connection.sessionConfig$.pipe(operators_1.filter((c3) => c3.metadata && c3.metadata.EthereumAddress !== void 0)).pipe(operators_1.mergeMap((c3) => aes256gcm.decrypt(c3.metadata.EthereumAddress, this.session.secret))).subscribe({
      ...
      resetAndReload() {
        this.connection.setSessionMetadata("__destroyed", "1").pipe(operators_1.timeout(1e3), operators_1.catchError((_3) => rxjs_1.of(null))).subscribe((_3) => {
      ...
      handleIncomingEvent(event) {
        try {
          aes256gcm.decrypt(event.data, this.session.secret).pipe(operators_1.map((c3) => JSON.parse(c3))).subscribe({
            next: (json) => {
    ...
    var WalletLink = class {
      constructor(options) {
        ...
        if (!options.walletLinkUIConstructor) {
          walletLinkUIConstructor = (options2) => new WalletLinkSdkUI_1.WalletLinkSdkUI(options2);
        } else {
 ...
 * @license MIT
 */
//# sourceMappingURL=dist-DNWA55AY.js.map
