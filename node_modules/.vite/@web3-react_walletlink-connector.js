...
// dep:@web3-react_walletlink-connector
init_define_process_env();
        ...
        if (window.ethereum && window.ethereum.isCoinbaseWallet === true) {
          ...
          var _temp6 = function() {
            if (!_this3.walletLink) {
              return Promise.resolve(import("./dist-DNWA55AY.js").then(function(m) {
                var _m$default;
...
//# sourceMappingURL=@web3-react_walletlink-connector.js.map
