import {
  require_react_dom
} from "./chunk-7RSEWTQD.js";
import {
  require_object_assign,
  require_react
} from "./chunk-FKWVGUMN.js";
import {
  __commonJS,
  __objRest,
  __spreadProps,
...
var AccordionButton = React11.forwardRef((_a, ref) => {
  ...
  return (0, import_jsx_runtime6.jsx)(Component2, __spreadProps(__spreadValues({
    ...
    className: (0, import_classnames4.default)(className, bsPrefix, eventKey !== activeEventKey && "collapsed")
  }));
});
...
function useCommittedRef2(value) {
  var ref = (0, import_react17.useRef)(value);
...
function useEventCallback2(fn2) {
  var ref = useCommittedRef_default2(fn2);
...
function useGlobalListener(event, handler, capture) {
  ...
  var documentTarget = (0, import_react20.useCallback)(function() {
    return document;
  }, []);
...
var Button2 = React25.forwardRef((_a, ref) => {
  ...
  return (0, import_jsx_runtime21.jsx)(Component2, __spreadProps(__spreadValues(__spreadValues({}, props), buttonProps), {
    ref,
...
function useUpdateEffect(fn2, deps) {
  var isFirst = (0, import_react31.useRef)(true);
...
function useMounted2() {
  var mounted = (0, import_react32.useRef)(true);
  var isMounted = (0, import_react32.useRef)(function() {
    return mounted.current;
  });
...
function useUpdatedRef(value) {
  var valueRef = (0, import_react33.useRef)(value);
...
function useTimeout() {
  ...
  var handleRef = (0, import_react35.useRef)();
...
function useForceUpdate() {
  var _useReducer = (0, import_react37.useReducer)(function(state) {
    return !state;
...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react38.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
function useRootClose(ref, onRootClose, {
  ...
  const preventMouseRootCloseRef = (0, import_react40.useRef)(false);
...
var $f01a183cc7bdff77849e49ad26eb904$var$SSRContext = import_react42.default.createContext($f01a183cc7bdff77849e49ad26eb904$var$defaultContext);
function SSRProvider(props) {
  let cur = (0, import_react42.useContext)($f01a183cc7bdff77849e49ad26eb904$var$SSRContext);
  let value = (0, import_react42.useMemo)(() => ({
    prefix: cur === $f01a183cc7bdff77849e49ad26eb904$var$defaultContext ? "" : cur.prefix + "-" + ++cur.current,
    current: 0
  }), [cur]);
  return import_react42.default.createElement($f01a183cc7bdff77849e49ad26eb904$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function useSSRSafeId(defaultId) {
  let ctx = (0, import_react42.useContext)($f01a183cc7bdff77849e49ad26eb904$var$SSRContext);
  ...
  return (0, import_react42.useMemo)(() => defaultId || "react-aria" + ctx.prefix + "-" + ++ctx.current, [defaultId]);
}
  ...
  useGlobalListener("keydown", (event) => {
    ...
    switch (key) {
      ...
      case "ArrowDown":
        ...
        return;
      case "Tab":
        addEventListener_default(document, "keyup", (e) => {
...
var useIsomorphicEffect_default2 = isDOM || isReactNative2 ? import_react46.useLayoutEffect : import_react46.useEffect;
...
var FormCheck = React55.forwardRef((_a, ref) => {
  ...
  return (0, import_jsx_runtime47.jsx)(FormContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime47.jsx)("div", {
      style: style2,
      className: (0, import_classnames32.default)(className, label && bsPrefix, inline && `${bsPrefix}-inline`, type === "switch" && bsSwitchPrefix),
...
var import_warning5 = __toModule(require_warning());
...
var toFnRef3 = function toFnRef4(ref) {
  return !ref || typeof ref === "function" ? ref : function(value) {
    ref.current = value;
  };
};
...
var ListGroup = React73.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime67.jsx)(Nav_default, __spreadProps(__spreadValues({
    ...
    as,
    className: (0, import_classnames45.default)(className, bsPrefix, variant && `${bsPrefix}-${variant}`, horizontalVariant && `${bsPrefix}-${horizontalVariant}`)
  }));
});
...
function useUpdatedRef2(value) {
  var valueRef = (0, import_react64.useRef)(value);
  valueRef.current = value;
  return valueRef;
}
...
function useWillUnmount2(fn2) {
  var onUnmount = useUpdatedRef2(fn2);
...
function useWaitForDOMRef(ref, onResolved) {
  const [resolvedRef, setRef] = (0, import_react66.useState)(() => resolveContainerRef(ref));
  if (!resolvedRef) {
...
var Modal2 = React79.forwardRef((_a, ref) => {
  ...
  const renderBackdrop = (0, import_react69.useCallback)((backdropProps) => (0, import_jsx_runtime75.jsx)("div", __spreadProps(__spreadValues({}, backdropProps), {
...
var Navbar = React85.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime81.jsx)(NavbarContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime81.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime81.jsx)(Component2, __spreadProps(__spreadValues({
        ref
      }, controlledProps), {
...
var NavDropdown = React86.forwardRef((_a, ref) => {
  var _b = _a, {
    id,
    title,
    children,
...
var OffcanvasToggling = React87.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
    children
  ...
  return (0, import_jsx_runtime84.jsx)(TransitionWrapper_default, __spreadProps(__spreadValues({
    ref,
    addEndListener: transitionEndListener
  }, props), {
    childRef: children.ref,
    children: (status, innerProps) => React87.cloneElement(children, __spreadProps(__spreadValues({}, innerProps), {
...
OffcanvasToggling.defaultProps = defaultProps27;
...
var OffcanvasHeader = React88.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className
  } = _b, props = __objRest(_b, [
  ...
  return (0, import_jsx_runtime85.jsx)(AbstractModalHeader_default, __spreadProps(__spreadValues({
    ref
  }, props), {
...
OffcanvasHeader.defaultProps = defaultProps28;
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime86.jsx)(OffcanvasToggling_default, __spreadValues({}, props));
}
function BackdropTransition2(props) {
  return (0, import_jsx_runtime86.jsx)(Fade_default, __spreadValues({}, props));
}
var Offcanvas = React89.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
    children,
  ...
  const modalManager = (0, import_react74.useRef)();
  const handleHide = useEventCallback(onHide);
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  ...
  const renderBackdrop = (0, import_react74.useCallback)((backdropProps) => (0, import_jsx_runtime86.jsx)("div", __spreadProps(__spreadValues({}, backdropProps), {
    className: (0, import_classnames57.default)(`${bsPrefix}-backdrop`, backdropClassName)
  })), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime86.jsx)("div", __spreadProps(__spreadValues(__spreadValues({
    role: "dialog"
  }, dialogProps), props), {
    className: (0, import_classnames57.default)(className, bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  }));
...
Offcanvas.defaultProps = defaultProps29;
...
var Popover = React92.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    placement,
    className,
  ...
  return (0, import_jsx_runtime89.jsxs)("div", __spreadProps(__spreadValues({
    ref,
    role: "tooltip",
    style: style2,
    ...
    children: [(0, import_jsx_runtime88.jsx)("div", __spreadValues({
      className: "popover-arrow"
    }, arrowProps)), body ? (0, import_jsx_runtime88.jsx)(PopoverBody_default, {
      children
    }) : children]
  }));
});
...
var Overlay2 = React93.forwardRef((_a, outerRef) => {
  var _b = _a, {
    children: overlay,
    transition,
    popperConfig = {}
  ...
  return (0, import_jsx_runtime90.jsx)(Overlay_default, __spreadProps(__spreadValues({}, outerProps), {
    ref: mergedRef,
    ...
    children: (overlayProps, {
      ...
      return React93.cloneElement(overlay, __spreadProps(__spreadValues({}, overlayProps), {
        placement,
        arrowProps,
        popper: popper2,
...
var import_warning6 = __toModule(require_warning());
...
function OverlayTrigger(_a) {
  ...
  return (0, import_jsx_runtime93.jsxs)(import_jsx_runtime92.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react78.cloneElement)(children, triggerProps), (0, import_jsx_runtime91.jsx)(Overlay_default2, __spreadProps(__spreadValues({}, props), {
      show,
      onHide: handleHide,
      flip: flip2,
      placement,
...
var PageItem = React95.forwardRef((_a, ref) => {
  var _b = _a, {
    active,
    disabled,
    className,
  ...
  return (0, import_jsx_runtime94.jsx)("li", {
    ...
    children: (0, import_jsx_runtime95.jsxs)(Component2, __spreadProps(__spreadValues({
      className: "page-link",
      disabled
    }, props), {
...
function createButton(name, defaultValue, label = name) {
  function Button3(_a) {
    ...
    return (0, import_jsx_runtime95.jsxs)(PageItem, __spreadProps(__spreadValues({}, props), {
...
var Pagination = React96.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
    size: size2
  ...
  return (0, import_jsx_runtime96.jsx)("ul", __spreadProps(__spreadValues({
    ref
  }, props), {
...
var PlaceholderButton = React97.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime97.jsx)(Button_default2, __spreadProps(__spreadValues({}, placeholderProps), {
    ref,
    disabled: true,
    tabIndex: -1
  }));
...
var Placeholder = React98.forwardRef((_a, ref) => {
  var _b = _a, {
    as: Component2 = "span"
  } = _b, props = __objRest(_b, [
    "as"
  ...
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime98.jsx)(Component2, __spreadProps(__spreadValues({}, placeholderProps), {
    ref
  }));
});
...
var ProgressBar = React99.forwardRef((_a, ref) => {
  var _b = _a, {
    isChild
  } = _b, props = __objRest(_b, [
    "isChild"
...
var Ratio = React100.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
    children,
...
var Row = React101.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
    as: Component2 = "div"
...
var Spinner = React102.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    variant,
    animation,
...
var SplitButton = React103.forwardRef((_a, ref) => {
  var _b = _a, {
    id,
    bsPrefix,
    size: size2,
  ...
  return (0, import_jsx_runtime104.jsxs)(Dropdown_default2, __spreadProps(__spreadValues({
    ref
  }, props), {
...
var Stack = React104.forwardRef((_a, ref) => {
  var _b = _a, {
    as: Component2 = "div",
    bsPrefix,
    className,
  ...
  return (0, import_jsx_runtime105.jsx)(Component2, __spreadProps(__spreadValues({}, props), {
    ref,
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react80.useRef)(inProp);
...
var _excluded9 = ["active", "eventKey", "mountOnEnter", "transition", "unmountOnExit"];
...
var TabPanel = React105.forwardRef((_ref2, ref) => {
  let {
    as: Component2 = "div"
...
var TabContainer = (_a) => {
  ...
  return (0, import_jsx_runtime108.jsx)(Tabs_default, __spreadProps(__spreadValues({}, props), {
...
var TabPane = React108.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    transition
  } = _b, props = __objRest(_b, [
  ...
  return (0, import_jsx_runtime109.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime109.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime109.jsx)(Transition2, {
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime109.jsx)(Component2, __spreadProps(__spreadValues({}, rest), {
          ref,
...
var Table = React110.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
    striped,
  ...
  const table = (0, import_jsx_runtime112.jsx)("table", __spreadProps(__spreadValues({}, props), {
    className: classes,
    ref
  }));
  if (responsive) {
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime114.jsxs)(Tabs_default, {
    ...
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime113.jsx)(Nav_default2, __spreadProps(__spreadValues({}, controlledProps), {
      role: "tablist",
      as: "ul",
      ...
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime113.jsx)(TabPane_default, __spreadValues({}, childProps));
      })
    })]
  });
};
...
var ToastFade = React112.forwardRef((props, ref) => (0, import_jsx_runtime115.jsx)(Fade_default, __spreadProps(__spreadValues({}, props), {
  ref,
...
var ToastHeader = React114.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    closeLabel,
    closeVariant,
  ...
  return (0, import_jsx_runtime117.jsxs)("div", __spreadProps(__spreadValues({
    ref
  }, props), {
...
var Toast = React115.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
  ...
  const toast = (0, import_jsx_runtime118.jsx)("div", __spreadProps(__spreadValues({}, props), {
    ref,
...
var ToastContainer = React116.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    position,
    className,
  ...
  return (0, import_jsx_runtime119.jsx)(Component2, __spreadProps(__spreadValues({
    ref
  }, props), {
...
var noop6 = () => void 0;
var ToggleButton = React117.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    name,
    className,
  ...
  return (0, import_jsx_runtime122.jsxs)(import_jsx_runtime121.Fragment, {
    children: [(0, import_jsx_runtime120.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime120.jsx)(Button_default2, __spreadProps(__spreadValues({}, props), {
      ref,
...
var import_invariant4 = __toModule(require_browser());
...
var ToggleButtonGroup = React118.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime123.jsx)(ButtonGroup_default, __spreadProps(__spreadValues({}, controlledProps), {
    ref,
    children: map(children, (child) => {
      const values = getValues();
      const {
...
var Tooltip = React119.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    placement,
    className,
  ...
  const [primaryPlacement] = (placement == null ? void 0 : placement.split("-")) || [];
  const bsDirection = getOverlayDirection(primaryPlacement, isRTL);
  return (0, import_jsx_runtime125.jsxs)("div", __spreadProps(__spreadValues({
    ref,
    style: style2,
    role: "tooltip",
    "x-placement": primaryPlacement,
    ...
    children: [(0, import_jsx_runtime124.jsx)("div", __spreadValues({
      className: "tooltip-arrow"
    }, arrowProps)), (0, import_jsx_runtime124.jsx)("div", {
